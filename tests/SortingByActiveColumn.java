 ...
 */
public class SortingByActiveColumn {
    /**
    ...
    /**
     * This test check sorting by status in ascending and descending order.
     * functionality.
     */
    @Test
    public final void sortingByStatusTest() {
        mainPage = new MainPage();
        specification
                .For(mainPage.commentStatusColumnHeaderClick()
                        .getCommentsInMainPage())
                .listSortedByActiveInAscendingOrder()
                .next()
                .For(new MainPage().commentStatusColumnHeaderClick()
                        .getCommentsInMainPage())
                .listSortedByActiveInDescendingOrder()
                .next()
                .check();
    }
